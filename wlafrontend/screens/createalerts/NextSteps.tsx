  ...
  return (
    ...
    >
      <ImageBackground source={require("../../assets/desertbg.png")}>
        ...
        >
          <Text className="text-center text-2xl font-extrabold px-4 mt-48">
            You posted an Alert!
          </Text>
          <Text className="text-center text-lg font-light px-4 mt-2">
            Good Work. A pin will show up on the map, and nearby registered
            users who can help will now get an alert.
          </Text>
          <Text className="text-center text-xl font-extrabold px-4 mt-6">
            Next Steps:
          </Text>
          <Text className="text-center text-lg font-light px-4 mt-2 mb-14">
            Utilize the online resources list.
          </Text>
          <Button
            className="w-24 absolute bottom-24"
